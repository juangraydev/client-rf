  ...
  return (
    <main className="relative min-h-screen flex  text-white max-h-[calc(100vh - 150px)]">
      <div className="h-[calc(100vh-202px)] w-full mt-[140px] z-10 px-[1rem] relative">
        <div className="text-left leading-[0.9] absolute top-[calc(45%-120px)] left-[5%]">
        ...
        <div className="absolute top-[calc(50%+64px)] left-[5%]">
            <Button
                type="default"
                className="!h-[64px] !w-[200px] !text-[20px] !bg-[#FBAA0F] !text-[#FFF] !font-[800] !rounded-[10px] !border-none hover:!bg-white hover:!text-[#FBAA0F] transition-all duration-300"
            >
                DOWNLOAD NOW
            </Button>
        </div>
